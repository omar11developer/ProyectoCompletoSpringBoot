package com.groupomar.facturadigital.controllers;

import com.groupomar.facturadigital.models.entity.Cliente;
import com.groupomar.facturadigital.models.entity.Factura;
import com.groupomar.facturadigital.models.entity.ItemFactura;
import com.groupomar.facturadigital.models.entity.Producto;
import com.groupomar.facturadigital.models.service.IClienteService;
...
public class FacturaController {
    ...
    public String guardar(@Valid Factura factura, BindingResult result, Model model, @RequestParam(name = "item_id[]", required = false)Long[] itemId,
        ...
        if (itemId == null || itemId.length == 0){
            model.addAttribute("titulo", "Crear Factura");
            model.addAttribute("error","Error: La factura no puede no tener lienas");
            return "factura/form";
        }
